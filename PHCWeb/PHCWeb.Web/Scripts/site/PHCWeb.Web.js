...
(function (PHCWeb) {
    ...
    })(Organization = PHCWeb.Organization || (PHCWeb.Organization = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Organization;
...
(function (PHCWeb) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return PHCWeb.LanguageList.getValue();
            };
    ...
    })(Northwind = PHCWeb.Northwind || (PHCWeb.Northwind = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Northwind;
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(PHCWeb.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(PHCWeb.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (PHCWeb) {
    ...
    })(Common = PHCWeb.Common || (PHCWeb.Common = {}));
})(PHCWeb || (PHCWeb = {}));
...
(function (PHCWeb) {
    ...
    (function (Northwind) {
        ...
        }(PHCWeb.Common.GridEditorDialog));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(PHCWeb.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        PHCWeb.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: PHCWeb.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                PHCWeb.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (PHCWeb) {
    ...
    })(Membership = PHCWeb.Membership || (PHCWeb.Membership = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Membership;
...
(function (PHCWeb) {
    ...
    })(Meeting = PHCWeb.Meeting || (PHCWeb.Meeting = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Meeting;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: PHCWeb.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = PHCWeb.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
...
(function (PHCWeb) {
    var Default;
    (function (Default) {
        var EmpleadoDialog = (function (_super) {
    ...
    })(Default = PHCWeb.Default || (PHCWeb.Default = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Default;
    (function (Default) {
        var EmpleadoGrid = (function (_super) {
...
(function (PHCWeb) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = PHCWeb.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = PHCWeb.LanguageList || (PHCWeb.LanguageList = {}));
})(PHCWeb || (PHCWeb = {}));
...
(function (PHCWeb) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = PHCWeb.LanguageList.getValue;
    })(ScriptInitialization = PHCWeb.ScriptInitialization || (PHCWeb.ScriptInitialization = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Common;
...
(function (PHCWeb) {
    ...
    PHCWeb.BasicProgressDialog = BasicProgressDialog;
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new PHCWeb.BasicProgressDialog();
...
(function (PHCWeb) {
    ...
    })(DialogUtils = PHCWeb.DialogUtils || (PHCWeb.DialogUtils = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Common;
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(PHCWeb.Northwind.OrderGrid));
        BasicSamples.WrappedHeadersGrid = WrappedHeadersGrid;
    })(BasicSamples = PHCWeb.BasicSamples || (PHCWeb.BasicSamples = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var BasicSamples;
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return PHCWeb.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return PHCWeb.Northwind.SalesByCategoryService.baseUrl; };
            /**
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: PHCWeb.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return PHCWeb.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return PHCWeb.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return PHCWeb.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return PHCWeb.Northwind.OrderService.baseUrl; };
            /**
            ...
            QuickFilterCustomization.prototype.getQuickFilters = function () {
                ...
                var fld = PHCWeb.Northwind.OrderRow.Fields;
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return PHCWeb.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return PHCWeb.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return PHCWeb.Northwind.ProductService.baseUrl; };
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            PHCWeb.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
                        ...
                        var dlg = new PHCWeb.Northwind.OrderDialog();
                        this.initDialog(dlg);
                        dlg.loadEntityAndOpenDialog({
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = PHCWeb.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
...
(function (PHCWeb) {
    ...
    PHCWeb.SelectableEntityGrid = SelectableEntityGrid;
})(PHCWeb || (PHCWeb = {}));
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return PHCWeb.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return PHCWeb.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return PHCWeb.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(PHCWeb.SelectableEntityGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(PHCWeb.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new PHCWeb.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new PHCWeb.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new PHCWeb.Northwind.OrderDialog().loadEntityAndOpenDialog({
                        CustomerID: item.CustomerID,
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, PHCWeb.Northwind.OrderRow.Fields.ShipCountry);
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return PHCWeb.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return PHCWeb.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return PHCWeb.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = PHCWeb.Northwind.ProductRow.Fields;
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(PHCWeb.Common.BulkServiceAction));
...
(function (PHCWeb) {
    ...
    PHCWeb.StaticTextBlock = StaticTextBlock;
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var BasicSamples;
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(PHCWeb.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return PHCWeb.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new PHCWeb.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = PHCWeb.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(PHCWeb.Northwind.OrderDetailDialog));
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(PHCWeb.Northwind.OrderDetailsEditor));
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return PHCWeb.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return PHCWeb.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return PHCWeb.Northwind.OrderService.baseUrl; };
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = PHCWeb.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return PHCWeb.Northwind.ProductRow.lookupKey;
            };
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    PHCWeb.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(PHCWeb.Northwind.CustomerDialog));
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return PHCWeb.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return PHCWeb.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return PHCWeb.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return PHCWeb.Northwind.OrderService.baseUrl; };
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(PHCWeb.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(PHCWeb.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    PHCWeb.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return PHCWeb.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return PHCWeb.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return PHCWeb.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return PHCWeb.Northwind.OrderService.baseUrl; };
        ...
        var OtherFormOneBarDialog = (function (_super) {
            ...
            function OtherFormOneBarDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(PHCWeb.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    idPrefix: _this.idPrefix + "_Customer_",
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new PHCWeb.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
            ...
            OtherFormOneBarDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(PHCWeb.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
            ...
            OtherFormOneBarDialog.prototype.saveCustomer = function (callback, onSuccess) {
                ...
                if (!id) {
                    ...
                    PHCWeb.Northwind.CustomerService.Update({
                        EntityId: id,
                        Entity: c
                    }, function (response) {
                        // reload customer list just in case
                        Q.reloadLookup(PHCWeb.Northwind.CustomerRow.lookupKey);
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    PHCWeb.Northwind.CategoryService.Retrieve({
        ...
        }(PHCWeb.Northwind.CategoryDialog));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: PHCWeb.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: PHCWeb.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var chai = PHCWeb.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = PHCWeb.Northwind.EmployeeRow.getLookup().items
...
(function (PHCWeb) {
    ...
    })(Administration = PHCWeb.Administration || (PHCWeb.Administration = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Administration;
...
(function (PHCWeb) {
    ...
    })(Authorization = PHCWeb.Authorization || (PHCWeb.Authorization = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
    var Administration;
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return PHCWeb.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PHCWeb.BasicSamples || (PHCWeb.BasicSamples = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return PHCWeb.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return PHCWeb.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PHCWeb.BasicSamples || (PHCWeb.BasicSamples = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
...
(function (PHCWeb) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return PHCWeb.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return PHCWeb.StaticTextBlock; }], ['FromLocalText', function () { return PHCWeb.StaticTextBlock; }], ['DisplayFieldValue', function () { return PHCWeb.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PHCWeb.BasicSamples || (PHCWeb.BasicSamples = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
...
(function (PHCWeb) {
    var Default;
    (function (Default) {
        var EmpleadoForm = (function (_super) {
        ...
        [,
            ['Apellido', function () { return Serenity.StringEditor; }],
            ['Nombre', function () { return Serenity.StringEditor; }],
            ['Legajo', function () { return Serenity.StringEditor; }],
            ['FechaIngreso', function () { return Serenity.DateEditor; }],
            ['Dni', function () { return Serenity.IntegerEditor; }],
            ['Cuil', function () { return Serenity.StringEditor; }],
            ['FechaNacimiento', function () { return Serenity.DateEditor; }],
            ['EsActivo', function () { return Serenity.BooleanEditor; }],
            ['Telefono', function () { return Serenity.StringEditor; }],
            ['Email', function () { return Serenity.StringEditor; }],
            ['Domiclio', function () { return Serenity.StringEditor; }],
            ['Sexo', function () { return Serenity.StringEditor; }]
...
(function (PHCWeb) {
    ...
    (function (Default) {
        ...
        (function (EmpleadoRow) {
            ...
            EmpleadoRow.nameProperty = 'Apellido';
...
(function (PHCWeb) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'PHCWeb.Northwind.Entities.Gender');
    })(Northwind = PHCWeb.Northwind || (PHCWeb.Northwind = {}));
})(PHCWeb || (PHCWeb = {}));
var PHCWeb;
(function (PHCWeb) {
...
//# sourceMappingURL=PHCWeb.Web.js.map